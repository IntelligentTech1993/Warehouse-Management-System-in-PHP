...
if ( ! function_exists('dateIndoNews'))
{
	function dateIndoNews($tgl='')
	{
...
if ( ! function_exists('dateIndo1'))
{
	function dateIndo1($tgl='')
	{
		$waktu 	= substr ($tgl,11,5);
		$tanggal = substr ($tgl,8,2);
		$bulan = getBulan(substr($tgl,5,2));
...
if ( ! function_exists('getBulan2'))
{
	function getBulan2($bulan2='')
	{
		switch ($bulan2){
			case 1:
				return "Jan";
...
if ( ! function_exists('dateAgenda'))
{
	function dateIndoAgenda($tgl='')
	{
		$waktu 	= substr ($tgl,11,5);
		$tanggal = substr ($tgl,8,2);
		$bulan2 = getBulan2(substr($tgl,5,2));
		$tahun = substr ($tgl,0,4);
		return $bulan2;
	}
}
...
if ( ! function_exists('dateIndo6'))
{
	function dateIndo6($tgl='')
	{
		$tanggal = substr($tgl,8,2);
		$bulan = substr($tgl,5,2);
		$tahun = substr ($tgl,0,4);
